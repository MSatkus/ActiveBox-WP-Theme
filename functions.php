...
function theme_scripts(){
    ...
    if ( !is_admin() ) {
        ...
        wp_register_script('pace', ASSETS_URL . '/assets/scripts/pace.min.js', array('jquery'), 'false', true);
        wp_register_script('slick', ASSETS_URL . '/assets/slick/slick.min.js', array('pace'), 'false', true);
...
function theme_stylesheets(){
	...
	if( $styles_path ) {
		...
		wp_register_style('pace-css', ASSETS_URL . '/assets/css/pace-theme-center-simple.css', array(), false, 'all');
		wp_register_style('slick', ASSETS_URL . '/assets/slick/slick.css', array('pace-css'), false, 'all');
		wp_register_style('slick-theme', ASSETS_URL . '/assets/slick/slick-theme.css', array('slick'), false, 'all');
		wp_register_style('main-css', ASSETS_URL . '/assets/css/style.css', array('slick-theme'), false, 'all');

		wp_enqueue_style('pace-css');
